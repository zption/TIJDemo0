package com.zping.lib_thinking_in_java.gui;//: gui/InterruptableLongRunningCallable.java
// Using Callables for long-running tasks.

import com.zping.lib_thinking_in_java.net.mindview.util.TaskItem;
import com.zping.lib_thinking_in_java.net.mindview.util.TaskManager;
...
import static com.zping.lib_thinking_in_java.net.mindview.util.SwingConsole.run;
