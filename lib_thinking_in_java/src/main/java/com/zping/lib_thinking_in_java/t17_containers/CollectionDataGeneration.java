package com.zping.lib_thinking_in_java.t17_containers;//: containers/CollectionDataGeneration.java
// Using the Generators defined in the Arrays chapter.

import com.zping.lib_thinking_in_java.net.mindview.util.CollectionData;
